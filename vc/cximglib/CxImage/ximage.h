...
/** \addtogroup Painting */ //@{
	...
	*/
	int32_t	Draw(HDC hdc, int32_t x = 0, int32_t y = 0, int32_t cx = -1, int32_t cy = -1, RECT* pClipRect = 0, HPALETTE hPal = NULL, bool bSmooth = false, bool bFlipY = false);
	int32_t	Draw(HDC hdc, const RECT& rect, RECT* pClipRect = NULL, HPALETTE hPal = NULL, bool bSmooth = false, bool bFlipY = false);
	// END MICSTO
